...
```
```{r}
ggpairs(rw_acid, columns = 1:5, axisLabels = 'internal') 
...
As expected, correlations - pH and total acidity, somewhat less expected total acidity and fixed acidity, but a look back at the respecitve columns makes it seem much more intuitive.

Greatest correlations with quality - volatile acidity (negative) and citric acid.
