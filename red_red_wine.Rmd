...
ggplot(data = rw_copy, mapping = aes(x = quality_factor, y = alcohol)) +
  geom_boxplot(aes(fill=quality_factor)) + 
...
with advaned analytics. Using a pre-cleaned and tidied red wine dataset eliminated some 
ofthe difficulties inherent in data wrangling, but because the data is limited 
...
I wouldn't event generalize these relationships to all wines, but would focus 
